...
def distorted_inputs(data_dir, batch_size):
    ...
    with tf.name_scope('data_augmentation'):
        ...
        distorted_image = tf.random_crop(reshape_image, [height, width, 3])
    ...
    return generate_image_and_label_batch(float_image, read_input.label, min_queue_examples, batch_size, shuffle=True)
...
def inputs(eval_data, data_dir, batch_size):
    ...
    return generate_image_and_label_batch(float_image, read_input.label, min_queue_examples, batch_size, shuffle=False)
